...
import Gemini from "@/components/icons/gemini-icon";
...
export const AICustomize = ({
  ...
  const handleApply = async () => {
    ...
    try {
      ...
      const apiKey = process.env.NEXT_PUBLIC_VITE_GEMINI_KEY;
      ...
      if (!imageGenResponse.ok) {
        ...
        console.error(
          "API Error:",
          imageGenResponse.status,
          imageGenResponse.statusText,
          errorText
        );
        setIsLoading(false);
        return;
    ...
    <>
      <div className="customize-container">
        <div className="image-display" style={{ position: "relative" }}>
          ...
          <button type="button" title="generate" className="generate-dp-btn" onClick={onGenerateDP}>
            GENERATE DP!
          </button>
        </div>
