...
const JoinUs = () => {
  return (
    <div className="flex justify-center bg-[#FCF6DF] px-3 py-3 md:px-36 md:py-4">
      <div className="flex w-full flex-col items-center justify-center space-y-5 rounded-sm bg-[#171717] p-5 text-white md:space-y-7 md:p-8 lg:rounded-xl lg:p-18">
