...
export const metadata: Metadata = {
  ...
  description:
    "Secure your ticket for DevFest Lagos 2026! Get tickets for the premier tech conference, featuring talks on Mobile, Cloud, Web, AI/ML, Design, and more, from Nov 18th-22nd.",
  icons: {
    icon: "/logo.svg",
  },
  openGraph: {
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "DevFest Lagos 2026 | Ticketing OG Image",
      },
    ],
  },
};
