...
const Home = () => {
  return (
    <div className="relative h-[calc(100vh-32px)] overflow-hidden bg-[#FFFAEB]">
        ...
        <div className="z-[1] text-center">
          ...
          <Link href="/dp-generator/create">
            <button
              ...
              className="relative mt-4 h-[60px] w-[258px] cursor-pointer rounded-[36px] border-4 border-black bg-[#F6B51E] p-4 font-['Akira','Arial_Black',sans-serif] text-lg font-bold tracking-[1.5px] text-black uppercase opacity-100 transition-all duration-300 ease-in-out max-md:w-full"
            >
              CREATE YOURS!
            </button>
          </Link>
      ...
      <section className="relative z-[2] flex max-md:hidden">
        <div className="w-full">
          <div className="relative overflow-visible [transform-style:preserve-3d]">
            <img
      ...
      {/* Mobile Section */}
      <section className="relative z-[2] hidden max-md:mt-[18px] max-md:flex">
        <div className="w-full">
          <div className="relative overflow-visible [transform-style:preserve-3d]">
            <img
              className="relative z-[1] block h-auto"
